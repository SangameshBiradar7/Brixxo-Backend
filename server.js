...
const socketOrigins = process.env.NODE_ENV === 'production'
  ...
  : [process.env.FRONTEND_URL || "http://localhost:3000", "http://localhost:3000", "http://localhost:3001","https://www.brixxo.in","https://brixxo-frontend-zdqa-n6ecayzei-sangameshs-projects-fd9ee526.vercel.app"]
